...
# --- CONFIGURATION (Aapke Sequence ke Hisab se) ---
API_ID = 37197223
...
CH1_LINK = "https://t.me/+zIPvYrqHaZU4YTdl"
...
# Inhe Lists mein set kar diya gaya hai
...
async def start(client, message):
    ...
    if len(message.command) > 1:
        if user_id not in ADMINS:
            ...
            if not is_joined:
                # Buttons automatically using LINKS sequence
                buttons = [
