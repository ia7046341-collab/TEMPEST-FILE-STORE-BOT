...
# --- ADMINS ---
ADMINS = [7426624114, 5029489287, 5893066075] 
...
async def start(client, message):
    ...
    # Check if user clicked a file link
    if len(message.command) > 1:
        ...
        try:
            ...
            del_msg = await message.reply_text("✅ **File Sent!**\n\nThis will be deleted in 30 minutes for security.")
        ...
        # Simple welcome for direct start (No Force Sub buttons)
        welcome_text = "👋 **Welcome to Tempest Anime Provider**\n\nI am online and ready! Send me a file to generate a link."
